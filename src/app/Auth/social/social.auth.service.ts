...
export interface LoginOpt {
    ...
    Valid values are popup and redirect. */
    ux_mode?: string;
    ...
    /*
     ...
     and consent. The possible values are:
      ...
      select_account
        The authorization server prompts the user to select a user account. This allows a user who has multiple accounts at the 
        authorization server to select amongst the multiple accounts that they may have current sessions for.
