...
! function(n, e, i, s) {
    n.xs_nav = function(a, t) {
        ...
        r.showOffcanvas = function() {
            ...
            r.settings.responsive ? (e <= r.settings.mobileBreakpoint && u > r.settings.mobileBreakpoint && (n(a).addClass("xs_nav-portrait").removeClass("xs_nav-landscape"), S(), t !== s && r.callback("onPortrait")), e > r.settings.mobileBreakpoint && d <= r.settings.mobileBreakpoint && (n(a).addClass("xs_nav-portrait").removeClass("xs_nav-landscape"), k(), b(), r.hideOffcanvas(), t !== s && r.callback("onLandscape")), u = e, d = e) : (n(a).addClass("xs_nav-portrait"), k(), t !== s && r.callback("onLandscape"))
        };
        var g = function() {
